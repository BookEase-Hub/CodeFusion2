...
export default function BillingPage() {
  ...
  const handleSubscriptionChange = async () => {
    if (!requireAuth("changing your subscription")) {
      return
    }
              ...
              <CardContent>
                <div className="rounded-md border p-4">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    {user.subscriptionPlan === "premium" ? (
                      <Button variant="outline" onClick={() => requireAuth("managing your subscription")}>
                        Manage Subscription
                      </Button>
                    ) : (
                      <Button
        ...
        <Dialog open={confirmDialogOpen} onOpenChange={setConfirmDialogOpen}>
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button onClick={handleSubscriptionChange}>{selectedPlan === "premium" ? "Upgrade" : "Downgrade"}</Button>
            </DialogFooter>
          </DialogContent>
        </Dialog>
      </div>
