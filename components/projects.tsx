...
export function Projects() {
  ...
  const handleNewProject = () => {
    // Check if user is authenticated before creating a new project
                ...
                <Card key={project.id} className="overflow-hidden">
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => handleProjectAction("editing")}>Edit</DropdownMenuItem>
                          <DropdownMenuItem onClick={() => handleProjectAction("duplication")}>
                            Duplicate
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => handleProjectAction("archiving")}>Archive</DropdownMenuItem>
                          <DropdownMenuItem
                            className="text-destructive"
                            onClick={() => handleProjectAction("deletion")}
                          >
                            Delete
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                  ...
                  <CardFooter className="flex justify-between border-t pt-4">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="gap-1"
                      onClick={() => handleProjectAction("opening")}
                    >
            ...
            {projects.slice(0, 3).map((project) => (
              <Card key={project.id} className="overflow-hidden">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem onClick={() => handleProjectAction("archiving")}>Archive</DropdownMenuItem>
                        <DropdownMenuItem className="text-destructive" onClick={() => handleProjectAction("deletion")}>
                          Delete
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                    </DropdownMenu>
                ...
                <CardFooter className="flex justify-between border-t pt-4">
                  ...
                  <Button variant="outline" size="sm" className="gap-1" onClick={() => handleProjectAction("opening")}>
                    <Code className="h-3 w-3" />
                    Open
                  </Button>
                </CardFooter>
