...
export function AuthModal() {
  ...
  const { showAuthModal, authTriggerReason, setShowAuthModal, login, signup, resetPassword } = useAuth()
        ...
        <DialogHeader className="text-center">
          <div className="flex justify-center mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-montserrat font-bold text-xl">CodeFusion</span>
            </div>
          </div>
          <DialogTitle>Authentication Required</DialogTitle>
          <DialogDescription>
            {authTriggerReason || "Please sign in or create an account to access this feature."}
          </DialogDescription>
        </DialogHeader>
